...
#ifndef PROJECT_BSM_APPLICATION_H
#define PROJECT_BSM_APPLICATION_H
 ...
 */
class ProjectBsmApplication : public Application
{
public:
  /**
...
#endif /* PROJECT_BSM_APPLICATION_H*/
